...
class Bot
    ...
    private def random_response(key)
    ...
    private def best_sentence(input)
            ...
            if sentence.match('\b' + pattern.gsub(/\*/, '') + '\b')
                ...
                if pattern.include?('*')
                    responses << @data[:responses][:pattern].collect do |phrase|
                        ...
                        # Then substitute the text after the placeholder
                        # with the pronouns swtiched
